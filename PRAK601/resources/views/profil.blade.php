...
<div class="content-wrapper">
    <div class="card-profile">
        <img src="{{ asset('image/photoprofile.jpeg') }}" alt="Foto Profil" class="profile-img">
        ...
        <div class="mb-4">
            ...
            <div class="d-inline-block px-4 py-2 mt-2 rounded-3" 
                ...
                <i class="bi bi-person-badge-fill me-1"></i> {{ $profile['nim'] }}
            </div>
        </div>
        ...
        <div class="info-box">
            ...
            <div>
                ...
                <div class="fs-5 fw-bold" style="color: var(--text-brown-black);">{{ $profile['prodi'] }}</div>
            </div>
        </div>
        ...
        <div class="info-box">
            ...
            <div class="w-100">
                ...
                @if(is_array($profile['hobi']))
                    @foreach($profile['hobi'] as $hobi)
                        <span class="badge-skill">{{ $hobi }}</span>
                    @endforeach
                @else
                    <span class="badge-skill">{{ $profile['hobi'] }}</span>
                @endif
            </div>
        </div>
    ...
    <div class="col-6 col-md-3">
        <div class="card card-exp text-center p-0 h-100">
            ...
            <div class="p-3 d-flex flex-column flex-grow-1 justify-content-between">
                ...
                <h6 class="mb-3 fw-bold">{{ $exp['nama'] }}</h6>

                <a href="{{ url('/pengalaman/' . $exp['id']) }}"
