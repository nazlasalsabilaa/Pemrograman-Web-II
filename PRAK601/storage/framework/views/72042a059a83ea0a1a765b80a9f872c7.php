...
<div class="content-wrapper">
    ...
    <div class="detail-card">
        <div class="row g-0">
            <!-- Foto Kiri -->
            <div class="col-md-5">
                <img src="<?php echo e($pengalaman['gambar']); ?>" alt="<?php echo e($pengalaman['judul']); ?>" 
                     style="width: 100%; height: 100%; aspect-ratio: 9/16; object-fit: cover;">
            </div>
            <!-- Deskripsi Kanan -->
            <div class="col-md-7">
                <div class="detail-body">
                    <span class="badge-time"><i class="bi bi-calendar-event"></i> <?php echo e($pengalaman['waktu']); ?></span>
                    <h1 class="fw-bold mb-4" style="color: var(--text-brown-black);"><?php echo e($pengalaman['judul']); ?></h1>

                    <div class="description-box">
                        <h5 class="section-title"><i class="bi bi-journal-text"></i> Deskripsi Kegiatan</h5>
                        <p class="mb-0"><?php echo e($pengalaman['deskripsi']); ?></p>
                    </div>

                    <div class="kesan-box">
                        <h5 class="section-title"><i class="bi bi-heart-fill"></i> Kesan yang Dirasakan</h5>
                        <p class="mb-0"><?php echo e($pengalaman['kesan']); ?></p>
                    </div>
...
</html><?php /**PATH C:\laragon\www\PRAK601\resources\views/detail.blade.php ENDPATH**/ ?>